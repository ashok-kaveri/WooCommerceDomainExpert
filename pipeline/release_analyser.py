...
RELEASE_ANALYSIS_PROMPT = dedent("""\
    You are a senior QA lead and Woo (Multi-Carrier Shipping Labels) WooCommerce App domain expert
    ...
    {{
      ...
      "kb_context_summary": "<key Woo domain facts relevant to this release>"
    }}
""")
