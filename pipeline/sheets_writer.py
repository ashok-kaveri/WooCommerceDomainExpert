"""
pipeline/sheets_writer.py — Google Sheets writer for Woo test case data.
...
def check_duplicates(
    ...
    try:
        ...
        gc = gspread.authorize(creds)
        sh = gc.open_by_key(config.GOOGLE_SHEETS_ID)
        # Exact match first to avoid "Woo 373" matching "Woo 373a"
        ws = None
...
def append_to_sheet(
    ...
    """Parse TCs and append to the correct Woo master sheet tab. Returns metadata dict.
    ...
    # Exact match first to avoid "Woo 373" swallowing "Woo 373a"
