# Setting Up WooCommerce Shipping Services Plugin

**Source:** https://www.pluginhive.com/knowledge-base/setting-up-woocommerce-shipping-services-plugin/
...
* * *
  ...
  * **[How to Create Shipping Zones](http://@shipping-zones)**
...
### **Store Checkout Integration with WooCommerce Shipping Services plugin**

Your WooCommerce store can display live USPS shipping rates at checkout using the **WooCommerce Shipping Services plugin** , integrated with your **Stamps.com USPS account**.

Customers can choose from services like:
...
**Enable the Realtime Rates in WooCommerce:**  
To show the live rates at checkout, the Realtime Rates option must be enabled on your WooCommerce store.   
  
**Without CCS:**

  * The plugin can’t send live rates to the checkout.
  * Customers will only see flat rates defined within WooCommerce.
  * Accurate pricing and service options may be lost.

**How to enable Realtime Rates:**  
To enable the Realtime Rates in your WooCommerce store, in the WordPress admin panel, navigate to:  
_WooCommerce > Settings > Shipping > PluginHive WooCommerce Shipping Services > General_  
and enable the **Realtime Rates** option.
