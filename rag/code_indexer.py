"""
Code Indexer  —  Source Code RAG for Woo Domain Expert
========================================================
...
Collections:
  woo_code_knowledge  (separate from the QA knowledge collection woo_knowledge)

Each chunk stores metadata:
  source_type : "woo_plugin" | "woo_shipping_pro" | "automation"
...
Usage:
  ...
  # Index woocommerce-plugins server code (run once, or when code changes)
  result = index_codebase("/path/to/woocommerce-plugins/server/src/shared", "woo_plugin")
...
def index_codebase(
    ...
    Args:
        ...
        source_type:    Source label stored in metadata
                        (e.g. "woo_plugin", "woo_shipping_pro", "automation")
...
def search_code(
    ...
    Args:
        ...
        source_type: Filter by source_type (e.g. "woo_plugin", "woo_shipping_pro")
...
def get_index_stats() -> dict:
    ...
    Returns {"woo_plugin": N, "woo_shipping_pro": M, "automation": K,
             "total": N+M+K, "error": ""}
    ...
    def _empty_stats(error: str = "") -> dict:
        return {"woo_plugin": 0, "woo_shipping_pro": 0,
    ...
    def _stats_from_sqlite(error: str = "") -> dict:
        ...
        return {
            "woo_plugin":  counts["woo_plugin"],
            "woo_shipping_pro":  counts["woo_shipping_pro"],
            "automation":           counts["automation"],
            "total":                total,
            "server_sync":          sync_state.get("woo_plugin", {}),
            "client_sync":          sync_state.get("woo_shipping_pro", {}),
    ...
    try:
        ...
        server_cnt     = _count("woo_plugin")
        client_cnt     = _count("woo_shipping_pro")
        automation_cnt = _count("automation")

        sync_state = _load_sync_state()
        return {
            "woo_plugin":  server_cnt,
            "woo_shipping_pro":  client_cnt,
...
def sync_from_git(
    ...
    Args:
        ...
        source_type: "automation" | "woo_plugin" | "woo_shipping_pro"
