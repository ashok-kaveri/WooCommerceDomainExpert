...
_SOURCE_LABELS: dict[str, str] = {
    "kb_articles":         "Woo Knowledge Base Articles",
    "wiki":                "Woo Internal Wiki",
    "sheets":              "TC Sheet (Google Sheets)",
    "woo_pluginsaas":        "plugin source SaaS Codebase",
    "woo_plugin": "plugin source SaaS Server Code",
    "woo_shipping_pro": "plugin source SaaS Client Code",
    "automation":          "Woo Test Automation Codebase",
    "woo_api_recipes": "WooCommerce REST/Store API Recipes for Woo QA",
}
...
class SimpleConversationalChain:
    ...
    def _build_labeled_context(docs: list[Document]) -> str:
        ...
        accurately say "According to the Woo Knowledge Base..." or "The internal
