"""
Woo Domain Expert — Streamlit Web Chat UI
...
QUICK_ASKS = [
    ...
    "What are the Woo carrier-specific special services?",
...
def _render_sidebar() -> None:
    with st.sidebar:
        ...
        st.caption("🌐 Woo Knowledge Base Articles")
        st.caption("📖 Woo Internal Wiki")
        st.caption("📊 TC Sheet (Google Sheets)")
        st.caption("💻 Woo Test Automation Codebase")
        st.caption("🗂️ plugin source SaaS Codebase")
...
def main() -> None:
    ...
    st.header("💬 Ask your Woo App Expert")
    st.caption("Ask anything about the WooCommerce plugin — features, carriers, label generation, test cases, and more.")
    ...
    if "pending_question" in st.session_state:
        ...
        question = st.chat_input("Ask anything about the WooCommerce plugin…")
